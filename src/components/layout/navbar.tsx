...
export const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-6">
          <div className="flex h-16 items-center justify-between md:h-20">
            ...
            <Link href="/" className="group relative flex items-center gap-3">
              <div className="from-accent flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br to-blue-500 transition-transform duration-500 group-hover:rotate-180">
            ...
            <nav className="hidden items-center gap-1 rounded-2xl bg-white/5 px-2 py-2 backdrop-blur-md md:flex">
              {navLinks.map((link) => (
                ...
                >
                  ...
                  <span>{link.name}</span>
                  {isLinkActive(link.href) && (
                    <div className="from-accent/20 absolute inset-0 -z-10 rounded-xl bg-gradient-to-r to-blue-500/20" />
                  )}
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="bg-background/95 animate-in slide-in-from-top-2 fixed inset-x-0 top-16 z-40 border-b backdrop-blur-xl duration-300 md:hidden">
