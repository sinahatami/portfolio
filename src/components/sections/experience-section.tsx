...
export const ExperienceSection = () => {
  return (
    <SectionContainer
      ...
      subtitle={`${RESUME_DATA.work.length} roles spanning 5+ years of industry experience`}
    >
      <ScrollRevealStagger threshold={0.1} once={false}>
        {" "}
        {/* Changed here */}
        <ExpandableList
          initialCount={3}
          items={RESUME_DATA.work.map((work, index) => (
            <ScrollRevealItem key={`${work.company}-${work.start}`}>
